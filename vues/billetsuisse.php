...
<p>SUISSE</p>
    ...
    <div class="dvContainer" id="dvContainer" style="font-family: 'Courier New', Courier, monospace;font-size: 20px;">
        ...
        <div class="contain9">
            <div>
                ARRIVAL: PARIS,  ZURICH, CH (ZURICH AIRPORT), TERMINAL 2
            </div>
        ...
        <div class="contain8">
            ...
            <div>
            ZURICH, CH (ZURICH AIRPORT), TERMINAL 2
            </div>
            <div class="divN" id="divse" style="margin-left: 142px;">
            <?php 
        ...
        <div class="contain9">
            ...
            <div class="divY" id="divh" style="margin-left: 321px;">
            <?php 
                echo $date = date("d M", strtotime("+0 day", strtotime($dateRetour[1])));
