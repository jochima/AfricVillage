...
<p>SENEGAL</p>
    ...
    <div class="dvContainer" id="dvContainer" style="font-family: 'Courier New', Courier, monospace;">
        ...
        <div class="contain6">
            ...
            <div class="div6" id="div6" style="margin-left:270px">
            <?php
        ...
        <div class="contain9">
            <div>
                ARRIVAL: DAKAR, (AEROPORT INTERNATIONAL BLAISE-DIAGNE),
            </div>
            <div class="div9" id="div9" style="margin-left:35px">
            <?php
              echo $dateDepart[1]; 
            ?> 09:00
            </div>
        ...
        <div class="contain10">
            <div class="Fbooking" id="fbooking">
                FLIGHT BOOKING REF: HC/<?php  echo  $function1 ; ?>
            </div>
        </div>
        <div class="contain11">
            <div class="Freserv">
        ...
        <div class="contain8">
            ...
            <div>
            DAKAR, (AEROPORT INTERNATIONAL BLAISE-DIAGNE),
            </div>
            <div class="divN" id="divN" style="margin-left:50px;">
            <?php 
        ...
        <div id="tick" style="margin-top: 40px">
            TICKET: HC/ESAT 235 <?php echo  $function2; ?> FOR <?php 
                            if(isset($_POST['nom']) && !empty($_POST['nom'])){
