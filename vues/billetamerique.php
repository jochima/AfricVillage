...
<?php
                ...
                if (isset($_POST['impression'])) { 
                    ...
                    header('Location: billetamerique.php');
                }
...
<p>USA</p>
    ...
    <div class="dvContainer" id="dvContainer" style="font-family: 'Courier New', Courier, monospace;font-size: 20px; margin-top: 100px" style="text-transform:uppercase;">
        ...
        <div class="contain9">
            ...
            <div class="div9" id="div9" style="margin-left: 217px;" style="text-transform:uppercase;">
        ...
        <div class="contain8">
            ...
            <div class="divN" id="divN" style="margin-left: 245px; text-transform:uppercase;">
            <?php   echo $date = date("d M", strtotime("+1 day", strtotime($dateDepart[1])));?> 10:10
            </div>
        </div>
        <div class="contain9">
            <div>
                ARRIVAL: NEW YORK, NY (JOHN F KENNEDY INTL), TERMINAL 1
            </div>
            <div class="divY" id="divY" style="margin-left: 64px; text-transform:uppercase;">
        ...
        <div class="contain12">
            <div>
                NON STOP ISTANBUL TO NEW YORK, NY 
            </div>
        </div>
        <div class="contain14">
            <div class="equip">
        ...
        <div class="contain15">
            ...
            <div class="div15" id="divs" style="margin-left: 238px; text-transform:uppercase;">
        ...
        <div class="contain8">
            ...
            <div>
            NEW YORK, NY (JOHN F KENNEDY INTL), TERMINAL 1
            </div>
            <div class="divN" id="divse" style="margin-left: 60px; text-transform:uppercase;">
        ...
        <div class="contain9">
            ...
            <div class="divY" id="divh" style="margin-left: 240px; text-transform:uppercase;">
        ...
        <div class="contain12">
            <div>
                NON STOP NEW YORK, NY TO ISTANBUL 
            </div>
        </div>
        <div class="contain14">
            <div class="equip">
        ...
        <div class="contain15">
            ...
            <div class="div15" id="divd" style="margin-left: 230px; text-transform:uppercase;">
        ...
        <div class="contain8">
            ...
            <div class="divN" id="divo" style="margin-left: 230px; text-transform:uppercase;">
