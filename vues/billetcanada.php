...
<p>CANADA</p>
    ...
    <div class="dvContainer" id="dvContainer" style="font-family: 'Courier New', Courier, monospace;">
        ...
        <div class="contain">
            ...
            BOOKING REF : <?php  echo  $function1 ; ?>            </div>
        </div>
        <div class="contain2">
            <div>
                BP : DOUALA
        ...
        <div class="contain9">
            <div>
                ARRIVAL: NEWARK, NJ (NEWARK LIBERTY INTL), TERMINAL B
            </div>
        ...
        <div class="contain12">
            <div>
                NON STOP BRUSSELS TO NEWARK, NJ 
            </div>
        </div>
        <div class="contain14">
            <div class="equip">
        ...
        <div class="contain6">
            ...
            <div>
                &nbsp; UA 4909 - UNITED AIRLINES
            </div>
            <div class="div6" id="divt" style="margin-left: 220px;">
            <?php   echo $date = date("D d F Y", strtotime("+1 day", strtotime($dateDepart[1])));?>
            </div>
        </div>
        <div class="contain7">
        ...
        <div class="contain8">
            ...
            <div>
                NEWARK, NJ (NEWARK LIBERTY INTL), TERMINAL C
            </div>
            <div class="div8" id="divq" style="margin-left: 64px;">
            <?php   echo $date = date("d M", strtotime("+1 day", strtotime($dateDepart[1])));?> 02:00
            </div>
        </div>
        <div class="contain9">
            <div>
                ARRIVAL: TORONTO, ON (LESTER B. PEARSON INTL), TERMINAL 1
            </div>
            <div class="div9" id="divc" style="margin-left: 17px;">
        ...
        <div class="contain12">
            <div>
                NON STOP NEWARK, NJ TO TORONTO, ON 
            </div>
        </div>
        <div class="contain13">
            <div class="oby">
        ...
        <div class="contain8">
            ...
            <div>
                TORONTO, ON (LESTER B. PEARSON INTL), TERMINAL 1
            </div>
        ...
        <div class="contain9">
            <div>
                ARRIVAL: DULLES/WASH, DC (DULLES INTL)
            </div>
            <div class="divY" id="divh" style="margin-left: 265px;">
        ...
        <div class="contain11">
            <div class="Freserv">
                RESERVATION CONFIRMED, ECONOMY (L)
            </div>
            <div class="div11">
                DURATION: 01:22
            </div>
        ...
        <div class="contain12">
            <div>
                NON STOP TORONTO, ON TO DULLES/WASH, DC 
            </div>
        </div>
        <div class="contain13">
            <div class="oby">
        ...
        <div class="contain8">
            ...
            <div>
                DULLES/WASH, DC (DULLES INTL)
            </div>
            <div class="divN" id="divo" style="margin-left: 260px;">
        ...
        <div class="contain9">
            ...
            <div class="divY" id="divdo" style="margin-left: 236px;">
            <?php echo $dateRetour[1];?> 00:30
            </div>
        </div>
        <div class="contain10">
        ...
        <div class="contain12">
            <div>
                NON DULLES/WASH, DC TO BRUSSELS 
            </div>
        </div>
        <div class="contain14">
            <div class="equip">
        ...
        <div class="contain15">
            ...
            <div>
                &nbsp;  SN 371 - BRUSSELS AIRLINES
            </div>
            <div class="div15" id="divtr" style="margin-left: 230px;">
            <?php   echo $date = date("D d F Y", strtotime("+1 day", strtotime($dateRetour[1])));?>
            </div>
        </div>
        <div class="contain16">
            <div>
        ...
        <div class="contain8">
            ...
            <div class="divN" id="divqu" style="margin-left: 243px;">
            <?php   echo $date = date("d M", strtotime("+1 day", strtotime($dateRetour[1])));?> 10:00
            </div>
        </div>
        <div class="contain9">
            <div>
            ...
            <div class="divY" id="divqi">
            <?php   echo $date = date("d M", strtotime("+1 day", strtotime($dateRetour[1])));?> 16:50
            </div>
        </div>
        <div class="contain10">
            <div class="Fbooking" id="sbooking">
                FLIGHT BOOKING REF: SN/ <?php  echo  $function1 ; ?>
            </div>
        </div>
        <div class="contain11">
