...
<p>MALI</p>
    ...
    <div class="dvContainer" id="dvContainer" style="font-family: 'Courier New', Courier, monospace;">
        ...
        <div class="contain6">
            ...
            <div class="div6" id="div6" style="margin-left:250px">
            <?php
        ...
        <div class="contain9">
            <div>
                ARRIVAL: BAMAKO, (AEROPORT INTERNATIONAL MODIBO KEITA),
            </div>
        ...
        <div class="contain8">
            ...
            <div>
            BAMAKO, (AEROPORT INTERNATIONAL MODIBO KEITA),
            </div>
            <div class="divN" id="divN" style="margin-left: 53px; ">
            <?php 
