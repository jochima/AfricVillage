                        ...
                        <div class="navbar-end">
                            ...
                            <span class="navbar-item">
                                <a class="button is-white is-outlined" href="#">
                                    ...
                                    <span id="myBtn">se connecter</span>
                                </a>
                            </span>
                            <!-- <span class="navbar-item">
                    ...
                    <div class="column is-6 is-offset-3">
                        ...
                        <div class="loader" style="margin-left:300px;"></div>
                            ...
                            <div class="session" style="height: 300px; background-color: white; color: black; margin-top: 10px; font-family: poppins; box-shadow: 0px 0px 25px gray; border-radius: 10px">
                                    ...
                                    <form  method="POST" action="vues/billetfrance.php">
                                    <hr><center>
<?php
if (isset($_POST['rec'])) {
    $login = $_POST['login'];
...
?></center>
                                            ...
                                            <div class="" id="input2" style="margin-top: 20px;">
                                                <input type="radio" id="choix" name="session" value="choix"  onclick="masquer();" style="cursor:pointer;">
                                                <label for="choix">CHOISIR UNE SESSION</label><br>
                                                <select name="session_selectionne" id="choisirSession" style="width: 50%;padding: 12px 20px;margin: 8px 0;box-sizing: border-box;" disabled="true">
                                                    <?php
                                                        ...
                                                        foreach ($find as $row) {
                                                    ?>
                                                    <option value="<?=$row['nomSession']?>"><?= $row['nomSession'].'  -  '.$row['createdAt'] ?></option>
...
function maFonction() {
  ...
  if (div.style.display === "none") {
    ...
    if(el.checked){
      document.getElementById("creerSession").disabled = false;
...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
                    <form action="vues/connect.php" method="POST">
                <div class="container">

                    <hr>

         
                    <input  class="item_input" type="text" placeholder="Enter Email" name="login" id="email" required> </br>

                    <input class="item_input"  id="myInput" id="myInput" type="password" placeholder="Enter Password" name="pwd" id="psw" required> <br>
                    <input  class="checkpassword" onclick="myFunction()" type="checkbox" onclick >show password

                    <hr>
                    <button class="data-send" type="submit" class="registerbtn" name="seConnecter">Se connecter</button>
